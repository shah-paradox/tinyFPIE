...
def main():
    ...
    # 2. Initialize the OpenMP Grid Processor and swap the core for SolverV3
    print("Initializing OpenMP Solver v3...")
    proc = GridProcessor(
        gradient="src",
        backend="openmp",
    ...
    # Swap the backend core for the new SolverV3
    proc.core = core_openmp.SolverV3(8, 8, 8)
    ...
    # 5. Save the result
    write_image("result_v3.jpg", result)
    print("Saved result to result_v3.jpg")
