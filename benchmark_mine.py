...
def main():
    ...
    print("Initializing OpenMP Multigrid solver...")
    proc = GridProcessor(
        gradient="src",
        backend="openmp",
    ...
    proc.core = core_openmp.MultigridSolver(8, 8, 4)
    ...
    # 5. Save the result
    write_image("result_mine.jpg", result)
    print("Saved result to result_mine.jpg")
