# TINY Fast Poisson Image Editing (tinyFPIE)

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![Python 3.10+](https://img.shields.io/badge/python-3.10+-blue.svg)](https://www.python.org/downloads/)

TINY FPIE is a high-performance implementation of the Poisson Image Editing algorithm, implemented by fpie, providing several backends for CPU and GPU acceleration. It supports seamless image cloning, texture flattening, and illumination compensation with a focus on speed and efficiency.
